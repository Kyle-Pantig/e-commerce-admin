...
const Navbar = ({ showNavbar, setShowNavbar }) => {
  ...
  const activeLink = inActiveLink + " bg-white text-gray-900 rounded-md ";
  ...
  return (
    <aside
      className={
        ...
        "top-0 text-gray-500 p-4 fixed w-96 h-screen bg-gray-200 lg:static lg:w-auto transition-all duration-500"
      }
    >
